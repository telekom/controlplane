...
// DeleteRealm provides a mock function with given fields: ctx, realm
func (_m *MockRealmClient) DeleteRealm(ctx context.Context, realm string) error {
	ret := _m.Called(ctx, realm)
...
func (_c *MockRealmClient_DeleteRealm_Call) Return(_a0 error) *MockRealmClient_DeleteRealm_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRealmClient_DeleteRealm_Call) RunAndReturn(run func(context.Context, string) error) *MockRealmClient_DeleteRealm_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteRealmClient provides a mock function with given fields: ctx, realmName, id
func (_m *MockRealmClient) DeleteRealmClient(ctx context.Context, realmName string, id string) error {
	ret := _m.Called(ctx, realmName, id)
...
func (_c *MockRealmClient_DeleteRealmClient_Call) Return(_a0 error) *MockRealmClient_DeleteRealmClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRealmClient_DeleteRealmClient_Call) RunAndReturn(run func(context.Context, string, string) error) *MockRealmClient_DeleteRealmClient_Call {
	_c.Call.Return(run)
	return _c
}
