...
const (
	...
	certmanagerbaseUrl = "https://github.com/jetstack/cert-manager/releases/download/"
	certmanagerURL     = certmanagerbaseUrl + certmanagerVersion + "/cert-manager.yaml"
)
...
// LoadImageToKindClusterWithName LoadImageToKindCluster loads a local docker image to the kind cluster
