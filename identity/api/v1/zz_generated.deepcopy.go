...
func (in *ClaimConfig) DeepCopyInto(out *ClaimConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClaimConfig.
func (in *ClaimConfig) DeepCopy() *ClaimConfig {
	if in == nil {
		return nil
	}
	out := new(ClaimConfig)
...
func (in *ClientStatus) DeepCopyInto(out *ClientStatus) {
	*out = *in
	if in.RotatedSecretExpiresAt != nil {
		in, out := &in.RotatedSecretExpiresAt, &out.RotatedSecretExpiresAt
		*out = (*in).DeepCopy()
	}
	if in.SecretExpiresAt != nil {
...
func (in *SecretRotationConfig) DeepCopyInto(out *SecretRotationConfig) {
	*out = *in
	...
	out.RemainingRotationPeriod = in.RemainingRotationPeriod
}
