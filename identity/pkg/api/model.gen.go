...
//
// Code generated by github.com/oapi-codegen/oapi-codegen/v2 version v2.6.1-0.20260323204436-ddd9e9093462 DO NOT EDIT.
package api
...
// Valid indicates whether the value is a known member of the AccessTokenCategory enum.
func (e AccessTokenCategory) Valid() bool {
	switch e {
	case ACCESS:
		return true
	case ADMIN:
...
// Valid indicates whether the value is a known member of the PartialImportRepresentationPolicy enum.
func (e PartialImportRepresentationPolicy) Valid() bool {
	switch e {
	case FAIL:
		return true
	case OVERWRITE:
...
// Valid indicates whether the value is a known member of the PolicyRepresentationDecisionStrategy enum.
func (e PolicyRepresentationDecisionStrategy) Valid() bool {
	switch e {
	case PolicyRepresentationDecisionStrategyAFFIRMATIVE:
		return true
	case PolicyRepresentationDecisionStrategyCONSENSUS:
		return true
	case PolicyRepresentationDecisionStrategyUNANIMOUS:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PolicyRepresentationLogic enum.
func (e PolicyRepresentationLogic) Valid() bool {
	switch e {
	case NEGATIVE:
		return true
	case POSITIVE:
...
// Valid indicates whether the value is a known member of the ResourceServerRepresentationDecisionStrategy enum.
func (e ResourceServerRepresentationDecisionStrategy) Valid() bool {
	switch e {
	case ResourceServerRepresentationDecisionStrategyAFFIRMATIVE:
		return true
	case ResourceServerRepresentationDecisionStrategyCONSENSUS:
		return true
	case ResourceServerRepresentationDecisionStrategyUNANIMOUS:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ResourceServerRepresentationPolicyEnforcementMode enum.
func (e ResourceServerRepresentationPolicyEnforcementMode) Valid() bool {
	switch e {
	case DISABLED:
		return true
	case ENFORCING:
...
// GetRealmClientPoliciesPoliciesParams defines parameters for GetRealmClientPoliciesPolicies.
type GetRealmClientPoliciesPoliciesParams struct {
