...
func (in *FileTypeStatus) DeepCopyInto(out *FileTypeStatus) {
	*out = *in
	...
	if in.SFTPUserRef != nil {
		in, out := &in.SFTPUserRef, &out.SFTPUserRef
		*out = (*in).DeepCopy()
	}
}
...
func (in *ZoneServiceConfigSpec) DeepCopyInto(out *ZoneServiceConfigSpec) {
	*out = *in
	...
	out.ServiceExternal = in.ServiceExternal
}
...
func (in *ZoneServiceConfigStatus) DeepCopyInto(out *ZoneServiceConfigStatus) {
	*out = *in
	...
	if in.SFTPZoneServiceConfigRef != nil {
		in, out := &in.SFTPZoneServiceConfigRef, &out.SFTPZoneServiceConfigRef
		*out = (*in).DeepCopy()
	}
}
