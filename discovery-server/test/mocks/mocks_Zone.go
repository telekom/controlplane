...
func NewZoneStoreMock(testing ginkgo.FullGinkgoTInterface) store.ObjectStore[*adminv1.Zone] {
	mockStore := csmocks.NewMockObjectStore[*adminv1.Zone](testing)
	ConfigureZoneStoreMock(testing, mockStore)
	return mockStore
}

func ConfigureZoneStoreMock(testing ginkgo.FullGinkgoTInterface, mockedStore *csmocks.MockObjectStore[*adminv1.Zone]) {
