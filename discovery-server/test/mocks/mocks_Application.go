...
func NewApplicationStoreMock(testing ginkgo.FullGinkgoTInterface) store.ObjectStore[*applicationv1.Application] {
	mockStore := csmocks.NewMockObjectStore[*applicationv1.Application](testing)
	ConfigureApplicationStoreMock(testing, mockStore)
	return mockStore
}

func ConfigureApplicationStoreMock(testing ginkgo.FullGinkgoTInterface, mockedStore *csmocks.MockObjectStore[*applicationv1.Application]) {
