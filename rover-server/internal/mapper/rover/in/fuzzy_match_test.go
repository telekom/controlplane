...
var _ = DescribeTable("FuzzyMatchClientAuthMethod",
	...
	// BASIC variants
	Entry("basic", "basic", api.AuthenticationClientAuthMethodBASIC),
	Entry("Basic", "Basic", api.AuthenticationClientAuthMethodBASIC),
	Entry("BASIC", "BASIC", api.AuthenticationClientAuthMethodBASIC),
	// POST variants
	Entry("body", "body", api.AuthenticationClientAuthMethodPOST),
	Entry("Body", "Body", api.AuthenticationClientAuthMethodPOST),
	Entry("BODY", "BODY", api.AuthenticationClientAuthMethodPOST),
	Entry("post", "post", api.AuthenticationClientAuthMethodPOST),
	Entry("Post", "Post", api.AuthenticationClientAuthMethodPOST),
	Entry("POST", "POST", api.AuthenticationClientAuthMethodPOST),
	// NONE variants
	Entry("none", "none", api.AuthenticationClientAuthMethodNONE),
	Entry("None", "None", api.AuthenticationClientAuthMethodNONE),
	Entry("NONE", "NONE", api.AuthenticationClientAuthMethodNONE),
	// Default passthrough
