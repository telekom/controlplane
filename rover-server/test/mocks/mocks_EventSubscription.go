...
func NewEventSubscriptionStoreMock(testing ginkgo.FullGinkgoTInterface) store.ObjectStore[*eventv1.EventSubscription] {
	mockStore := NewMockObjectStore[*eventv1.EventSubscription](testing)
	ConfigureEventSubscriptionStoreMock(testing, mockStore)
	return mockStore
}

func ConfigureEventSubscriptionStoreMock(testing ginkgo.FullGinkgoTInterface, mockedStore *MockObjectStore[*eventv1.EventSubscription]) {
