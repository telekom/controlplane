...
// ApiSubscription, EventSubscription, or AgenticSubscription (M2O). It
// resolves the subscription FK via cache-based meta-key lookup and uses
// namespace+name as the unique conflict key.
