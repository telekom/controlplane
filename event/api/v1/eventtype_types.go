...
// +kubebuilder:validation:XValidation:rule="!self.type.startsWith('de.telekom.ei.listener')",message="the 'de.telekom.ei.listener' event-type prefix is reserved for internal Spectre use"
