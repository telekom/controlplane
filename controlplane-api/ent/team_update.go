...
func (_u *TeamUpdate) SetTeamToken(v string) *TeamUpdate {
	_u.mutation.SetTeamToken(v)
	return _u
}

// SetNillableTeamToken sets the "team_token" field if the given value is not nil.
func (_u *TeamUpdate) SetNillableTeamToken(v *string) *TeamUpdate {
	if v != nil {
		_u.SetTeamToken(*v)
	}
	return _u
...
func (_u *TeamUpdate) ClearTeamToken() *TeamUpdate {
	_u.mutation.ClearTeamToken()
	return _u
}
...
func (_u *TeamUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.TeamToken(); ok {
		_spec.SetField(team.FieldTeamToken, field.TypeString, value)
	}
	if _u.mutation.TeamTokenCleared() {
		_spec.ClearField(team.FieldTeamToken, field.TypeString)
	}
...
// SetTeamToken sets the "team_token" field.
func (_u *TeamUpdateOne) SetTeamToken(v string) *TeamUpdateOne {
	_u.mutation.SetTeamToken(v)
	return _u
}

// SetNillableTeamToken sets the "team_token" field if the given value is not nil.
func (_u *TeamUpdateOne) SetNillableTeamToken(v *string) *TeamUpdateOne {
	if v != nil {
		_u.SetTeamToken(*v)
	}
	return _u
...
// ClearTeamToken clears the value of the "team_token" field.
func (_u *TeamUpdateOne) ClearTeamToken() *TeamUpdateOne {
	_u.mutation.ClearTeamToken()
	return _u
}
