...
const (
	...
	ExposuresColumn = "mcp_server_exposures"
)
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "mcp_servers"
...
func StatusPhaseValidator(sp StatusPhase) error {
	...
	case StatusPhaseReady, StatusPhasePending, StatusPhaseError, StatusPhaseUnknown:
		return nil
	default:
		return fmt.Errorf("mcpserver: invalid enum value for status_phase field: %q", sp)
	}
}
