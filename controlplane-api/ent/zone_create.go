...
func (_c *ZoneCreate) SetIssuerURL(v string) *ZoneCreate {
	_c.mutation.SetIssuerURL(v)
	return _c
}

// SetNillableIssuerURL sets the "issuer_url" field if the given value is not nil.
func (_c *ZoneCreate) SetNillableIssuerURL(v *string) *ZoneCreate {
	if v != nil {
		_c.SetIssuerURL(*v)
	}
	return _c
...
func (_c *ZoneCreate) AddFileExposureIDs(ids ...int) *ZoneCreate {
	_c.mutation.AddFileExposureIDs(ids...)
	return _c
}

// AddFileExposures adds the "file_exposures" edges to the FileExposure entity.
func (_c *ZoneCreate) AddFileExposures(v ...*FileExposure) *ZoneCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFileExposureIDs(ids...)
}

// AddFileSubscriptionIDs adds the "file_subscriptions" edge to the FileSubscription entity by IDs.
func (_c *ZoneCreate) AddFileSubscriptionIDs(ids ...int) *ZoneCreate {
	_c.mutation.AddFileSubscriptionIDs(ids...)
	return _c
}

// AddFileSubscriptions adds the "file_subscriptions" edges to the FileSubscription entity.
func (_c *ZoneCreate) AddFileSubscriptions(v ...*FileSubscription) *ZoneCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFileSubscriptionIDs(ids...)
}
...
func (_c *ZoneCreate) createSpec() (*Zone, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FileExposuresIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.FileSubscriptionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
...
// SetIssuerURL sets the "issuer_url" field.
func (u *ZoneUpsert) SetIssuerURL(v string) *ZoneUpsert {
	u.Set(zone.FieldIssuerURL, v)
	return u
}

// UpdateIssuerURL sets the "issuer_url" field to the value that was provided on create.
func (u *ZoneUpsert) UpdateIssuerURL() *ZoneUpsert {
	u.SetExcluded(zone.FieldIssuerURL)
	return u
}

// ClearIssuerURL clears the value of the "issuer_url" field.
func (u *ZoneUpsert) ClearIssuerURL() *ZoneUpsert {
	u.SetNull(zone.FieldIssuerURL)
	return u
}
...
// SetIssuerURL sets the "issuer_url" field.
func (u *ZoneUpsertOne) SetIssuerURL(v string) *ZoneUpsertOne {
	return u.Update(func(s *ZoneUpsert) {
		s.SetIssuerURL(v)
	})
}
...
// UpdateIssuerURL sets the "issuer_url" field to the value that was provided on create.
func (u *ZoneUpsertOne) UpdateIssuerURL() *ZoneUpsertOne {
	return u.Update(func(s *ZoneUpsert) {
		s.UpdateIssuerURL()
	})
}
...
// SetIssuerURL sets the "issuer_url" field.
func (u *ZoneUpsertBulk) SetIssuerURL(v string) *ZoneUpsertBulk {
	return u.Update(func(s *ZoneUpsert) {
		s.SetIssuerURL(v)
	})
}
...
// UpdateIssuerURL sets the "issuer_url" field to the value that was provided on create.
func (u *ZoneUpsertBulk) UpdateIssuerURL() *ZoneUpsertBulk {
	return u.Update(func(s *ZoneUpsert) {
		s.UpdateIssuerURL()
	})
}
