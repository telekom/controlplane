...
func NamespaceIsNil() predicate.ApiExposure {
	return predicate.ApiExposure(sql.FieldIsNull(FieldNamespace))
}

// NamespaceNotNil applies the NotNil predicate on the "namespace" field.
func NamespaceNotNil() predicate.ApiExposure {
	return predicate.ApiExposure(sql.FieldNotNull(FieldNamespace))
}
