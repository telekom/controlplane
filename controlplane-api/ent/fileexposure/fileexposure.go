...
const (
	// Label holds the string label denoting the fileexposure type in the database.
	Label = "file_exposure"
	...
	// Table holds the table name of the fileexposure in the database.
	Table = "file_exposures"
	// OwnerTable is the table that holds the owner relation/edge.
	OwnerTable = "file_exposures"
	...
	OwnerColumn = "application_exposed_file_types"
	// FileTypeDefTable is the table that holds the file_type_def relation/edge.
	FileTypeDefTable = "file_exposures"
	...
	FileTypeDefColumn = "file_type_exposures"
	// ZoneTable is the table that holds the zone relation/edge.
	ZoneTable = "file_exposures"
	...
	SubscriptionsColumn = "file_subscription_target"
)

// Columns holds all SQL columns for fileexposure fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldLastModifiedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "file_exposures"
...
func StatusPhaseValidator(sp StatusPhase) error {
	...
	case StatusPhaseReady, StatusPhasePending, StatusPhaseError, StatusPhaseUnknown:
		return nil
	default:
		return fmt.Errorf("fileexposure: invalid enum value for status_phase field: %q", sp)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityWorld, VisibilityZone, VisibilityEnterprise:
		return nil
	default:
		return fmt.Errorf("fileexposure: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the FileExposure queries.
