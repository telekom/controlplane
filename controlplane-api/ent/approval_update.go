...
func (_u *ApprovalUpdate) ClearStatusPhase() *ApprovalUpdate {
...
func (_u *ApprovalUpdate) SetDeciderTeamName(v string) *ApprovalUpdate {
...
func (_u *ApprovalUpdate) SetNillableDeciderTeamName(v *string) *ApprovalUpdate {
	if v != nil {
...
func (_u *ApprovalUpdate) ClearAvailableTransitions() *ApprovalUpdate {
...
func (_u *ApprovalUpdate) SetNillableName(v *string) *ApprovalUpdate {
	if v != nil {
		_u.SetName(*v)
	}
	return _u
...
func (_u *ApprovalUpdate) SetNillableEventSubscriptionID(id *int) *ApprovalUpdate {
	if id != nil {
...
func (_u *ApprovalUpdate) SetEventSubscription(v *EventSubscription) *ApprovalUpdate {
...
func (_u *ApprovalUpdate) check() error {
	...
	if v, ok := _u.mutation.Namespace(); ok {
		if err := approval.NamespaceValidator(v); err != nil {
			return &ValidationError{Name: "namespace", err: fmt.Errorf(`ent: validator failed for field "Approval.namespace": %w`, err)}
		}
	}
	...
	if v, ok := _u.mutation.DeciderTeamName(); ok {
		if err := approval.DeciderTeamNameValidator(v); err != nil {
			return &ValidationError{Name: "decider_team_name", err: fmt.Errorf(`ent: validator failed for field "Approval.decider_team_name": %w`, err)}
		}
	}
	if v, ok := _u.mutation.Name(); ok {
		if err := approval.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent: validator failed for field "Approval.name": %w`, err)}
		}
	}
...
func (_u *ApprovalUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.StatusPhaseCleared() {
		_spec.ClearField(approval.FieldStatusPhase, field.TypeEnum)
	}
	...
	if value, ok := _u.mutation.DeciderTeamName(); ok {
		_spec.SetField(approval.FieldDeciderTeamName, field.TypeString, value)
	}
	...
	if _u.mutation.EventSubscriptionCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   approval.EventSubscriptionTable,
			Columns: []string{approval.EventSubscriptionColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// ClearStatusPhase clears the value of the "status_phase" field.
func (_u *ApprovalUpdateOne) ClearStatusPhase() *ApprovalUpdateOne {
	_u.mutation.ClearStatusPhase()
	return _u
}
...
// SetDeciderTeamName sets the "decider_team_name" field.
func (_u *ApprovalUpdateOne) SetDeciderTeamName(v string) *ApprovalUpdateOne {
	_u.mutation.SetDeciderTeamName(v)
	return _u
}

// SetNillableDeciderTeamName sets the "decider_team_name" field if the given value is not nil.
func (_u *ApprovalUpdateOne) SetNillableDeciderTeamName(v *string) *ApprovalUpdateOne {
	if v != nil {
		_u.SetDeciderTeamName(*v)
	}
	return _u
...
// SetNillableName sets the "name" field if the given value is not nil.
func (_u *ApprovalUpdateOne) SetNillableName(v *string) *ApprovalUpdateOne {
	if v != nil {
		_u.SetName(*v)
	}
	return _u
...
// SetNillableEventSubscriptionID sets the "event_subscription" edge to the EventSubscription entity by ID if the given value is not nil.
func (_u *ApprovalUpdateOne) SetNillableEventSubscriptionID(id *int) *ApprovalUpdateOne {
	if id != nil {
		_u = _u.SetEventSubscriptionID(*id)
	}
	return _u
...
// SetEventSubscription sets the "event_subscription" edge to the EventSubscription entity.
func (_u *ApprovalUpdateOne) SetEventSubscription(v *EventSubscription) *ApprovalUpdateOne {
	return _u.SetEventSubscriptionID(v.ID)
}
