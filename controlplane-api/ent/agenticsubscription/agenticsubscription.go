...
const (
	// Label holds the string label denoting the agenticsubscription type in the database.
	Label = "agentic_subscription"
	...
	// Table holds the table name of the agenticsubscription in the database.
	Table = "agentic_subscriptions"
	// OwnerTable is the table that holds the owner relation/edge.
	OwnerTable = "agentic_subscriptions"
	...
	TargetInverseTable = "agentic_exposures"
	// TargetColumn is the table column denoting the target relation/edge.
	TargetColumn = "agentic_subscription_target"
	...
	ApprovalColumn = "agentic_subscription_approval"
	...
	ApprovalRequestsColumn = "agentic_subscription_approval_requests"
)

// Columns holds all SQL columns for agenticsubscription fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldLastModifiedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "agentic_subscriptions"
...
func StatusPhaseValidator(sp StatusPhase) error {
	...
	case StatusPhaseReady, StatusPhasePending, StatusPhaseError, StatusPhaseUnknown:
		return nil
	default:
		return fmt.Errorf("agenticsubscription: invalid enum value for status_phase field: %q", sp)
	}
}

// OrderOption defines the ordering options for the AgenticSubscription queries.
