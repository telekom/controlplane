...
// The EventExposureQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type EventExposureQueryRuleFunc func(context.Context, *ent.EventExposureQuery) error

// EvalQuery return f(ctx, q).
func (f EventExposureQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EventExposureQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.EventExposureQuery", q)
}

// The EventExposureMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type EventExposureMutationRuleFunc func(context.Context, *ent.EventExposureMutation) error

// EvalMutation calls f(ctx, m).
func (f EventExposureMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.EventExposureMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.EventExposureMutation", m)
}

// The EventSubscriptionQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type EventSubscriptionQueryRuleFunc func(context.Context, *ent.EventSubscriptionQuery) error

// EvalQuery return f(ctx, q).
func (f EventSubscriptionQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EventSubscriptionQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.EventSubscriptionQuery", q)
}

// The EventSubscriptionMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type EventSubscriptionMutationRuleFunc func(context.Context, *ent.EventSubscriptionMutation) error

// EvalMutation calls f(ctx, m).
func (f EventSubscriptionMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.EventSubscriptionMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.EventSubscriptionMutation", m)
}

// The EventTypeQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type EventTypeQueryRuleFunc func(context.Context, *ent.EventTypeQuery) error

// EvalQuery return f(ctx, q).
func (f EventTypeQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EventTypeQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.EventTypeQuery", q)
}

// The EventTypeMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type EventTypeMutationRuleFunc func(context.Context, *ent.EventTypeMutation) error

// EvalMutation calls f(ctx, m).
func (f EventTypeMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.EventTypeMutation); ok {
		return f(ctx, m)
	}
