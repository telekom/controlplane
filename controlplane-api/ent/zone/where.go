...
func IssuerURL(v string) predicate.Zone {
...
func IssuerURLEQ(v string) predicate.Zone {
	return predicate.Zone(sql.FieldEQ(FieldIssuerURL, v))
}

// IssuerURLNEQ applies the NEQ predicate on the "issuer_url" field.
func IssuerURLNEQ(v string) predicate.Zone {
	return predicate.Zone(sql.FieldNEQ(FieldIssuerURL, v))
}

// IssuerURLIn applies the In predicate on the "issuer_url" field.
func IssuerURLIn(vs ...string) predicate.Zone {
	return predicate.Zone(sql.FieldIn(FieldIssuerURL, vs...))
}

// IssuerURLNotIn applies the NotIn predicate on the "issuer_url" field.
func IssuerURLNotIn(vs ...string) predicate.Zone {
	return predicate.Zone(sql.FieldNotIn(FieldIssuerURL, vs...))
}

// IssuerURLGT applies the GT predicate on the "issuer_url" field.
func IssuerURLGT(v string) predicate.Zone {
	return predicate.Zone(sql.FieldGT(FieldIssuerURL, v))
}

// IssuerURLGTE applies the GTE predicate on the "issuer_url" field.
func IssuerURLGTE(v string) predicate.Zone {
	return predicate.Zone(sql.FieldGTE(FieldIssuerURL, v))
}

// IssuerURLLT applies the LT predicate on the "issuer_url" field.
func IssuerURLLT(v string) predicate.Zone {
	return predicate.Zone(sql.FieldLT(FieldIssuerURL, v))
}

// IssuerURLLTE applies the LTE predicate on the "issuer_url" field.
func IssuerURLLTE(v string) predicate.Zone {
	return predicate.Zone(sql.FieldLTE(FieldIssuerURL, v))
}

// IssuerURLContains applies the Contains predicate on the "issuer_url" field.
func IssuerURLContains(v string) predicate.Zone {
	return predicate.Zone(sql.FieldContains(FieldIssuerURL, v))
}

// IssuerURLHasPrefix applies the HasPrefix predicate on the "issuer_url" field.
func IssuerURLHasPrefix(v string) predicate.Zone {
	return predicate.Zone(sql.FieldHasPrefix(FieldIssuerURL, v))
}

// IssuerURLHasSuffix applies the HasSuffix predicate on the "issuer_url" field.
func IssuerURLHasSuffix(v string) predicate.Zone {
	return predicate.Zone(sql.FieldHasSuffix(FieldIssuerURL, v))
}

// IssuerURLIsNil applies the IsNil predicate on the "issuer_url" field.
func IssuerURLIsNil() predicate.Zone {
	return predicate.Zone(sql.FieldIsNull(FieldIssuerURL))
}

// IssuerURLNotNil applies the NotNil predicate on the "issuer_url" field.
func IssuerURLNotNil() predicate.Zone {
	return predicate.Zone(sql.FieldNotNull(FieldIssuerURL))
}

// IssuerURLEqualFold applies the EqualFold predicate on the "issuer_url" field.
func IssuerURLEqualFold(v string) predicate.Zone {
	return predicate.Zone(sql.FieldEqualFold(FieldIssuerURL, v))
}
