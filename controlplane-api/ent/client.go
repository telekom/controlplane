...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.EventExposure, c.EventSubscription, c.EventType, c.FileExposure,
		c.FileSubscription, c.FileType, c.Group, c.McpServer, c.Member,
...
type (
	hooks struct {
		...
		EventSubscription, EventType, FileExposure, FileSubscription, FileType, Group,
		McpServer, Member, PermissionSet, Team, Zone []ent.Hook
	}
	inters struct {
		AgentCard, AgenticExposure, AgenticSubscription, Api, ApiExposure,
		ApiSubscription, Application, Approval, ApprovalRequest, EventExposure,
		EventSubscription, EventType, FileExposure, FileSubscription, FileType, Group,
		McpServer, Member, PermissionSet, Team, Zone []ent.Interceptor
	}
)
