...
// ByTeamToken orders the results by the team_token field.
func ByTeamToken(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTeamToken, opts...).ToFunc()
}
