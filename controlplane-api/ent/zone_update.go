...
func (_u *ZoneUpdate) SetIssuerURL(v string) *ZoneUpdate {
	_u.mutation.SetIssuerURL(v)
	return _u
}

// SetNillableIssuerURL sets the "issuer_url" field if the given value is not nil.
func (_u *ZoneUpdate) SetNillableIssuerURL(v *string) *ZoneUpdate {
	if v != nil {
		_u.SetIssuerURL(*v)
	}
	return _u
...
func (_u *ZoneUpdate) ClearIssuerURL() *ZoneUpdate {
...
// SetIssuerURL sets the "issuer_url" field.
func (_u *ZoneUpdateOne) SetIssuerURL(v string) *ZoneUpdateOne {
	_u.mutation.SetIssuerURL(v)
	return _u
}

// SetNillableIssuerURL sets the "issuer_url" field if the given value is not nil.
func (_u *ZoneUpdateOne) SetNillableIssuerURL(v *string) *ZoneUpdateOne {
	if v != nil {
		_u.SetIssuerURL(*v)
	}
	return _u
