...
func (ec *executionContext) marshalOApiSubscriptionInfo2ᚖgithubᚗcomᚋtelekomᚋcontrolplaneᚋcontrolplaneᚑapiᚋpkgᚋmodelᚐApiSubscriptionInfo(ctx context.Context, sel ast.SelectionSet, v *model.ApiSubscriptionInfo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ApiSubscriptionInfo(ctx, sel, v)
