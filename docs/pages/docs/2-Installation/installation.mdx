...
kubectl get pods -n k get pods -n controlplane-system
```
...
<CardGrid columns={3}>
  <FeatureCard
    ...
    description={<>
      ...
      <code>kubectl logs -n controlplane-system deploy/gateway-controller-manager -c manager</code>
    </>}
  />
  ...
  <FeatureCard
    ...
    description={<>
      ...
      <code>kubectl get crds | grep cp.ei.telekom.de</code>
    </>}
  />
