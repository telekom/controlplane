...
| [API](./api.mdx) | API, APIExposure, APISubscription | Exposed APIs and their subscriptions |
| [Approval](./approval.mdx) | Approval, ApprovalRequest | Approval workflows and pending requests |
| [Agentic](./agentic.mdx) | MCPServer, AgentCard, AgenticExposure, AgenticSubscription | MCP servers and A2A agent cards, their exposures, and subscriptions |
