...
Consumer Failover, also known as **Data Traffic Control (DTC)**, takes a different approach. Instead of the gateway switching upstreams, the entire consumer is redirected to a different zone at the DNS level.
