...
import (
	...
	"github.com/telekom/controlplane/aurora/internal/controller"
...
func main() {
	...
	requirement, err := labels.NewRequirement(config.DomainLabelKey, selection.In, []string{"aurora"})
	if err != nil {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aurora.cp.ei.telekom.de",
		Cache: cache.Options{
