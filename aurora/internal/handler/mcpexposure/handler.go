...
var _ handler.Handler[*aurorv1.McpExposure] = &McpExposureHandler{}

type McpExposureHandler struct{}

func (h *McpExposureHandler) CreateOrUpdate(ctx context.Context, obj *aurorv1.McpExposure) error {
...
func (h *McpExposureHandler) Delete(ctx context.Context, obj *aurorv1.McpExposure) error {
	logger := log.FromContext(ctx)
