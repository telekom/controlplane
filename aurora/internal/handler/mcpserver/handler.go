...
var _ handler.Handler[*aurorv1.McpServer] = &McpServerHandler{}

type McpServerHandler struct{}

func (h *McpServerHandler) CreateOrUpdate(ctx context.Context, obj *aurorv1.McpServer) error {
	...
	if err := c.List(ctx, serverList, client.MatchingLabels{
		aurorv1.McpBasePathLabelKey: labelutil.NormalizeLabelValue(obj.Spec.BasePath),
	}); err != nil {
...
func (h *McpServerHandler) Delete(ctx context.Context, obj *aurorv1.McpServer) error {
