...
import (
	...
	"github.com/telekom/controlplane/aurora/internal/handler/mcpsubscription"
...
func buildScheme() *runtime.Scheme {
	...
	_ = aurorv1.AddToScheme(s)
	_ = applicationv1.AddToScheme(s)
	_ = approvalv1.AddToScheme(s)
	return s
}

func newMcpSubscription(name, basePath, zoneName string) *aurorv1.McpSubscription {
	return &aurorv1.McpSubscription{
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: "default",
			UID:       "sub-uid-1234",
		},
		Spec: aurorv1.McpSubscriptionSpec{
...
func makeReadyMcpExposure(basePath, zoneName string) aurorv1.McpExposure {
	exp := aurorv1.McpExposure{
		ObjectMeta: metav1.ObjectMeta{
			Name:              "test-exposure",
			Namespace:         "default",
			UID:               "exposure-uid",
...
var _ = Describe("McpSubscriptionHandler", func() {
	...
	setupPreApprovalMocks := func() {
		...
		mockListMcpExposures([]aurorv1.McpExposure{exposure})
	...
	Describe("CreateOrUpdate", func() {
		...
		It("should return BlockedError when visibility constraints are violated", func() {
			...
			exposure.Spec.Visibility = aurorv1.VisibilityZone
