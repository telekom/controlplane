...
type McpSubscriptionReconciler struct {
	...
	cc.Controller[*aurorv1.McpSubscription]
}

// +kubebuilder:rbac:groups=core,resources=events,verbs=create;patch
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpsubscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpsubscriptions/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpsubscriptions/finalizers,verbs=update
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpexposures,verbs=get;list;watch
...
func (r *McpSubscriptionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	return r.Controller.Reconcile(ctx, req, &aurorv1.McpSubscription{})
}
...
func (r *McpSubscriptionReconciler) MapMcpExposureToMcpSubscription(ctx context.Context, obj client.Object) []reconcile.Request {
	...
	list := &aurorv1.McpSubscriptionList{}
