...
type McpExposureReconciler struct {
	...
	cc.Controller[*aurorv1.McpExposure]
}

// +kubebuilder:rbac:groups=core,resources=events,verbs=create;patch
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpexposures,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpexposures/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpexposures/finalizers,verbs=update
...
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpservers,verbs=get;list;watch
// +kubebuilder:rbac:groups=aurora.cp.ei.telekom.de,resources=mcpsubscriptions,verbs=get;list;watch
...
func (r *McpExposureReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	return r.Controller.Reconcile(ctx, req, &aurorv1.McpExposure{})
}
...
func (r *McpExposureReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&aurorv1.McpSubscription{},
...
func (r *McpExposureReconciler) MapMcpExposureToMcpExposure(ctx context.Context, obj client.Object) []reconcile.Request {
	exposure, ok := obj.(*aurorv1.McpExposure)
	if !ok {
		return nil
	}
	...
	if err := r.List(ctx, list, client.MatchingLabels{
		...
		aurorv1.McpBasePathLabelKey: labelutil.NormalizeLabelValue(exposure.Spec.McpBasePath),
	}); err != nil {
		return nil
	}
...
func (r *McpExposureReconciler) MapRouteToMcpExposure(ctx context.Context, obj client.Object) []reconcile.Request {
	...
	basePathLabel := route.GetLabels()[aurorv1.McpBasePathLabelKey]
	if basePathLabel == "" {
		return nil
	}
	...
	if err := r.List(ctx, list, client.MatchingLabels{
		...
		aurorv1.McpBasePathLabelKey: basePathLabel,
	}); err != nil {
		return nil
	}
...
func (r *McpExposureReconciler) MapMcpSubscriptionToMcpExposure(ctx context.Context, obj client.Object) []reconcile.Request {
	sub, ok := obj.(*aurorv1.McpSubscription)
	if !ok {
		return nil
	}
	...
	if err := r.List(ctx, list, client.MatchingLabels{
		...
		aurorv1.McpBasePathLabelKey: labelutil.NormalizeLabelValue(sub.Spec.McpBasePath),
	}); err != nil {
		return nil
	}
