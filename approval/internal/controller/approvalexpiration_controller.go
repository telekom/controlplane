...
import (
	...
	approvalexpiration_handler "github.com/telekom/controlplane/approval/internal/handler/approvalexpiration"
	cconfig "github.com/telekom/controlplane/common/pkg/config"
	cc "github.com/telekom/controlplane/common/pkg/controller"
)

// ApprovalExpirationReconciler reconciles a ApprovalExpiration object
...
func (r *ApprovalExpirationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	r.Controller = cc.NewController(approvalexpiration_handler.NewHandler(), r.Client, r.Recorder)

	return ctrl.NewControllerManagedBy(mgr).
		For(&approvalv1.ApprovalExpiration{}, builder.WithPredicates(cc.Count("approvalexpiration", cc.RoleFor))).
