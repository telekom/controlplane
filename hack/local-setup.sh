...
ALL_CONTROLLERS=(
    ...
    "spectre:spectre/cmd:ghcr.io/telekom/controlplane/spectre"
...
step_summary() {
    ...
    echo "    kubectl port-forward -n ${CONTROLPLANE_NAMESPACE} svc/rustfs 9001:9001"
    echo "    # Browse http://localhost:9001 to open the RustFS console"
    echo "    # Login: controlplane / controlplane-local-rustfs (local development only)"
    echo ""
    echo "  Next steps:"
