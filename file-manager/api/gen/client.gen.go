...
func (c *Client) UploadFileWithBody(ctx context.Context, fileId string, params *UploadFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUploadFileRequestWithBody(c.Server, fileId, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewUploadFileRequestWithBody(server string, fileId string, params *UploadFileParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	if params != nil {
		...
		if params.XFileContentType != nil {
			var headerParam0 string

			headerParam0, err = runtime.StyleParamWithLocation("simple", false, "X-File-Content-Type", runtime.ParamLocationHeader, *params.XFileContentType)
			if err != nil {
				return nil, err
			}

			req.Header.Set("X-File-Content-Type", headerParam0)
		}

		if params.XFileChecksum != nil {
			var headerParam1 string

			headerParam1, err = runtime.StyleParamWithLocation("simple", false, "X-File-Checksum", runtime.ParamLocationHeader, *params.XFileChecksum)
			if err != nil {
				return nil, err
			}

			req.Header.Set("X-File-Checksum", headerParam1)
		}
...
func (c *ClientWithResponses) UploadFileWithBodyWithResponse(ctx context.Context, fileId string, params *UploadFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UploadFileResponse, error) {
	rsp, err := c.UploadFileWithBody(ctx, fileId, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
