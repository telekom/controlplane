...
type ClientInterface interface {
	...
	// UpsertAppWithBody request with any body
	UpsertAppWithBody(ctx context.Context, envId string, teamId string, appId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpsertApp(ctx context.Context, envId string, teamId string, appId string, body UpsertAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) UpsertAppWithBody(ctx context.Context, envId string, teamId string, appId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpsertAppRequestWithBody(c.Server, envId, teamId, appId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpsertApp(ctx context.Context, envId string, teamId string, appId string, body UpsertAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpsertAppRequest(c.Server, envId, teamId, appId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpsertAppRequest calls the generic UpsertApp builder with application/json body
func NewUpsertAppRequest(server string, envId string, teamId string, appId string, body UpsertAppJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpsertAppRequestWithBody(server, envId, teamId, appId, "application/json", bodyReader)
}

// NewUpsertAppRequestWithBody generates requests for UpsertApp with any type of body
func NewUpsertAppRequestWithBody(server string, envId string, teamId string, appId string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// UpsertAppWithBodyWithResponse request with any body
	UpsertAppWithBodyWithResponse(ctx context.Context, envId string, teamId string, appId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpsertAppResponse, error)

	UpsertAppWithResponse(ctx context.Context, envId string, teamId string, appId string, body UpsertAppJSONRequestBody, reqEditors ...RequestEditorFn) (*UpsertAppResponse, error)
...
// UpsertAppWithBodyWithResponse request with arbitrary body returning *UpsertAppResponse
func (c *ClientWithResponses) UpsertAppWithBodyWithResponse(ctx context.Context, envId string, teamId string, appId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpsertAppResponse, error) {
	rsp, err := c.UpsertAppWithBody(ctx, envId, teamId, appId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpsertAppWithResponse(ctx context.Context, envId string, teamId string, appId string, body UpsertAppJSONRequestBody, reqEditors ...RequestEditorFn) (*UpsertAppResponse, error) {
	rsp, err := c.UpsertApp(ctx, envId, teamId, appId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpsertAppResponse(rsp)
