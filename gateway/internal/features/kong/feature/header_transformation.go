...
var _ features.KongFeature = &HeaderTransformationFeature{}
...
func (f *HeaderTransformationFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *HeaderTransformationFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	route, ok := builder.GetRoute()
	if !ok {
