...
var _ features.KongFeature = &LastMileSecurityFeature{}
...
func (f *LastMileSecurityFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *LastMileSecurityFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	route, ok := builder.GetRoute()
	if !ok {
