...
var _ features.KongFeature = (*BasicAuthFeature)(nil)
...
func (b *BasicAuthFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (b *BasicAuthFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) error {
