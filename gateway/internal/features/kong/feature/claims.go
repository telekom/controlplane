...
var _ features.KongFeature = &ClaimsFeature{}
...
func (f *ClaimsFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *ClaimsFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) error {
