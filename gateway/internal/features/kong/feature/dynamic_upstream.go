...
var _ features.KongFeature = &DynamicUpstreamFeature{}
...
// Name implements features.KongFeature.
func (d *DynamicUpstreamFeature) Name() gatewayv1.FeatureType {
	return gatewayv1.FeatureTypeDynamicUpstream
}

// Priority implements features.KongFeature.
func (d *DynamicUpstreamFeature) Priority() int {
	return d.priority
}

// IsUsed implements features.KongFeature.
func (d *DynamicUpstreamFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
// Apply implements features.KongFeature.
func (d *DynamicUpstreamFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) error {
	route, ok := builder.GetRoute()
	if !ok {
