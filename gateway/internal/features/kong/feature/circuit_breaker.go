...
import (
	...
	"github.com/telekom/controlplane/gateway/internal/features/kong/feature/config"
	kong "github.com/telekom/controlplane/gateway/pkg/kong/api"
	"github.com/telekom/controlplane/gateway/pkg/kong/client"
	"github.com/telekom/controlplane/gateway/pkg/kong/client/plugin"
)

var _ features.KongFeature = &CircuitBreakerFeature{}
...
func (c CircuitBreakerFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (c CircuitBreakerFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) error {
...
func handleDeletion(ctx context.Context, builder features.KongFeatureBuilder, route *gatewayv1.Route) error {
...
func handleApply(ctx context.Context, builder features.KongFeatureBuilder, route *gatewayv1.Route) error {
