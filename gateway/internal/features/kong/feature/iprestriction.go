...
var _ features.KongFeature = &IpRestrictionFeature{}
...
func (f *IpRestrictionFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *IpRestrictionFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	consumer, ok := builder.GetConsumer()
	if !ok {
