...
var _ features.KongFeature = &LoadBalancingFeature{}
...
func (f *LoadBalancingFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *LoadBalancingFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	route, ok := builder.GetRoute()
	if !ok {
