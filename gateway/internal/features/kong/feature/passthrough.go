...
var _ features.KongFeature = &PassThroughFeature{}
...
func (f *PassThroughFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *PassThroughFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	route, ok := builder.GetRoute()
	if !ok {
