...
var _ features.KongFeature = &RateLimitFeature{}
...
func (f *RateLimitFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *RateLimitFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
	route, ok := builder.GetRoute()
	if !ok {
