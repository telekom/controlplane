...
var _ features.KongFeature = &CustomScopesFeature{}
...
func (f *CustomScopesFeature) IsUsed(ctx context.Context, builder features.KongFeatureBuilder) bool {
...
func (f *CustomScopesFeature) Apply(ctx context.Context, builder features.KongFeatureBuilder) (err error) {
