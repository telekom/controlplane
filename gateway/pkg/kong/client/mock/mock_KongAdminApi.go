...
// FetchTargetForUpstreamWithResponse provides a mock function with given fields: ctx, upstreamIdOrName, targetIdOrTarget, reqEditors
func (_m *MockKongAdminApi) FetchTargetForUpstreamWithResponse(ctx context.Context, upstreamIdOrName string, targetIdOrTarget string, reqEditors ...kong.RequestEditorFn) (*kong.FetchTargetForUpstreamResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for FetchTargetForUpstreamWithResponse")
	}

	var r0 *kong.FetchTargetForUpstreamResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, ...kong.RequestEditorFn) (*kong.FetchTargetForUpstreamResponse, error)); ok {
		return rf(ctx, upstreamIdOrName, targetIdOrTarget, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, ...kong.RequestEditorFn) *kong.FetchTargetForUpstreamResponse); ok {
		r0 = rf(ctx, upstreamIdOrName, targetIdOrTarget, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*kong.FetchTargetForUpstreamResponse)
		}
	}
...
// MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FetchTargetForUpstreamWithResponse'
type MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call struct {
	*mock.Call
}

// FetchTargetForUpstreamWithResponse is a helper method to define mock.On call
//   - ctx context.Context
//   - upstreamIdOrName string
//   - targetIdOrTarget string
//   - reqEditors ...kong.RequestEditorFn
func (_e *MockKongAdminApi_Expecter) FetchTargetForUpstreamWithResponse(ctx interface{}, upstreamIdOrName interface{}, targetIdOrTarget interface{}, reqEditors ...interface{}) *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call {
	return &MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call{Call: _e.mock.On("FetchTargetForUpstreamWithResponse",
		append([]interface{}{ctx, upstreamIdOrName, targetIdOrTarget}, reqEditors...)...)}
}

func (_c *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call) Run(run func(ctx context.Context, upstreamIdOrName string, targetIdOrTarget string, reqEditors ...kong.RequestEditorFn)) *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]kong.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call) Return(_a0 *kong.FetchTargetForUpstreamResponse, _a1 error) *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call) RunAndReturn(run func(context.Context, string, string, ...kong.RequestEditorFn) (*kong.FetchTargetForUpstreamResponse, error)) *MockKongAdminApi_FetchTargetForUpstreamWithResponse_Call {
	_c.Call.Return(run)
	return _c
}
