...
replace (
	...
	github.com/telekom/controlplane/gateway/api => ./api
...
require (
	...
	github.com/kgateway-dev/kgateway/v2 v2.3.6
...
require (
	...
	github.com/envoyproxy/go-control-plane/ratelimit v0.1.1-0.20250507123352-93990c5ec02f // indirect
