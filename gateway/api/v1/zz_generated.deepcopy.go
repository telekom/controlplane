...
func (in *ActiveHealthCheck) DeepCopyInto(out *ActiveHealthCheck) {
	*out = *in
	if in.HealthyHttpStatuses != nil {
		in, out := &in.HealthyHttpStatuses, &out.HealthyHttpStatuses
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
	if in.UnhealthyHttpStatuses != nil {
		in, out := &in.UnhealthyHttpStatuses, &out.UnhealthyHttpStatuses
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CircuitBreaker) DeepCopyInto(out *CircuitBreaker) {
	*out = *in
	in.Passive.DeepCopyInto(&out.Passive)
