...
func main() {
	cfg := config.LoadOrDie[config.EmptySpec]()
	...
	metricsServerOptions := metricsserver.Options{
		BindAddress:   cfg.Common.Metrics.BindAddress,
		SecureServing: cfg.Common.Metrics.SecureServing,
	...
	if cfg.Common.Metrics.SecureServing {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		HealthProbeBindAddress: cfg.Common.Probe.BindAddress,
		LeaderElection:         cfg.Common.LeaderElection.Enabled,
		LeaderElectionID:       cfg.Common.LeaderElection.ID,
