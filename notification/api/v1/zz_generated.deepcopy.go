...
func (in *AttachmentTemplate) DeepCopyInto(out *AttachmentTemplate) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AttachmentTemplate.
func (in *AttachmentTemplate) DeepCopy() *AttachmentTemplate {
	if in == nil {
		return nil
	}
	out := new(AttachmentTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NotificationTemplateSpec) DeepCopyInto(out *NotificationTemplateSpec) {
	*out = *in
	...
	if in.Attachments != nil {
		...
		*out = make([]AttachmentTemplate, len(*in))
		copy(*out, *in)
	}
}
