...
func (_m *MockResourceHandler) InfoMany(ctx context.Context, names []string) (interface{}, error) {
...
// MockResourceHandler_InfoMany_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InfoMany'
type MockResourceHandler_InfoMany_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - names []string
func (_e *MockResourceHandler_Expecter) InfoMany(ctx interface{}, names interface{}) *MockResourceHandler_InfoMany_Call {
	return &MockResourceHandler_InfoMany_Call{Call: _e.mock.On("InfoMany", ctx, names)}
}

func (_c *MockResourceHandler_InfoMany_Call) Run(run func(ctx context.Context, names []string)) *MockResourceHandler_InfoMany_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string))
	})
	return _c
...
func (_c *MockResourceHandler_InfoMany_Call) Return(_a0 interface{}, _a1 error) *MockResourceHandler_InfoMany_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockResourceHandler_InfoMany_Call) RunAndReturn(run func(context.Context, []string) (interface{}, error)) *MockResourceHandler_InfoMany_Call {
	_c.Call.Return(run)
	return _c
}
